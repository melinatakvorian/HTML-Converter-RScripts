...
#!!!PAY ATTENTION TO THE DIRECTION OF THE SLASHES. THEY HAVE TO BE CHANGED TO FORWARD SLASHES, AS SHOWN BELOW
  ...
  input_specific_folder <- "Document to HTML Table Converter/FilesForTesting/WildlandFire_test" #the specific folder inside the Document to HTML Table Converter where the input files are
  
  input_dir <-  paste0(input_umbrella, input_specific_folder) #Rename to your target directory. Outputs will appear here as well.
  project_name <- "OldStyle_refresh1" #Replace with whatever you want.
